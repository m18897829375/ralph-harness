...
| 维度 | 权重 | 阈值 | 评分标准 |
|------|------|------|---------|
| **功能完整性** | 30% | 95 | 合同验收标准是否**全部**满足？少一个 → 自动失败 |
| **代码质量** | 25% | 80 | 是否符合项目模式？有无硬编码秘密、安全漏洞、技术债？ |
| **UI/设计质量** | 25% | 90 | 视觉协调性/原创性/交互完整性。惩罚"AI slop" |
| **产品深度** | 20% | 80 | 是否只是壳子？数据是否真的流动？错误/加载/空状态是否处理？ |
